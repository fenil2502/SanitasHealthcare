        ...
        <div className="home-inner">
          ...
          <div className="zigzag">
            ...
            <div className="zigzag-text">
              <h2>About Sanitas</h2>
              <p>
                Sanitas Healthcare is occupied in the manufacturing of different
                range of nutraceuticals products (Tablets, Capsules, Powders,
                Syrup etc.)
              </p>
              <p>
                We at Sanitas Healthcare work at a state of the art
                manufacturing facility in Gujarat with large scale capacity for
                wide range of nutraceuticals products.
              </p>
            </div>
          </div>
          <div className="card-col">
            ...
            <div className="single-card">
              <div className="card">
                ...
                <h3>Mission</h3>
                <p>
                  To be a benchmark in manufacturing practices for production of
                  nutraceuticals healthcare products. To Dedicate ourseleves for
                  humanity’s quest for longer, healthier, happier lives through
                ...
                <div className="card">
                  ...
                  <div className="card-text">
                    ...
                    <p>
                      ...
                      Magnesium, Zinc Folic Acid, Methylcobalamin, Vitamin K27,
