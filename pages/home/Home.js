          ...
          <div className="home-inner">
              ...
              <div className="single-card">
                <div className="card">
                  ...
                  <p>
                    ...
                    of nutraceuticals healthcare products. To Dedicate
                    ourseleves for humanity’s quest for longer, healthier,
                    happier lives through innovation in medicines.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="portfolio">
              <div className="portfolio-heading">
                <h2>Portfolio</h2>
                {/* <Link onClick={() => NavigateTo(Routes.portfolio)} /> */}
              </div>
