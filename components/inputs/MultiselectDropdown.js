...
const customStyles = {
  ...
  option: (styles, { isFocused, isSelected, isUnchecked }) => ({
    ...
    color: isSelected ? '#757575' : undefined,
    zIndex: 1
  }),
  menuList: base => ({
    ...base,
...
const MultiSelectDropdown = (props) => {
  if (props.allowSelectAll) {
    return (
      <span
        className="d-inline-block multiselect-input"
        data-toggle="popover"
        data-trigger="focus"
  ...
  return (
    <span
      className="d-inline-block multiselect-input text-[#757575]"
      data-toggle="popover"
      data-trigger="focus"
      data-content="Please selecet account(s)"
    >
      <ReactSelect className="custom-checkbox-select text-[#757575]"
        styles={customStyles}
        {...props}
